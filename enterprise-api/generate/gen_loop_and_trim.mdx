---
title: "Generate, Trim and Loop Audio"
...
| `loopCount`        | `int`    | ✅ Yes    | Number of times to loop the detected seamless segment.                |
...
<Tabs>
  ...
  ```python
    ...
    url = "https://api-staging.soundverse.ai/v1/trim-and-loop/gen-and-loop/song/prompt/auto"
    headers = {
        "Authorization": "Bearer your_api_key_here",
        "Content-Type": "application/json"
    }
  ...
  ```sh
curl -X POST "https://api-staging.soundverse.ai/v1/trim-and-loop/gen-and-loop/song/prompt/auto" \
 -H "Authorization: Bearer your_api_key_here" \
 -H "Content-Type: application/json" \
 -d '{
      "prompt": "string",
...
<Tabs>
  ...
  ```python
    ...
    url = "https://api-staging.soundverse.ai/v1/trim-and-loop/gen-and-loop/song/lyrics/auto"
    headers = {
        "Authorization": "Bearer your_api_key_here",
        "Content-Type": "application/json"
    }
  ...
  ```sh
curl -X POST "https://api-staging.soundverse.ai/v1/trim-and-loop/gen-and-loop/song/lyrics/auto" \
 -H "Authorization: Bearer your_api_key_here" \
 -H "Content-Type: application/json" \
 -d '{
      "lyrics": "string",
