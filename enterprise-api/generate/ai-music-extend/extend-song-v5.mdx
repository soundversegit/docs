...
### **Endpoints**
- <Method type="POST">POST</Method> `/v5/extend/song` **- streaming**
- <Method type="POST">POST</Method> `/v5/extend/song/sync` **- synchronous**
...
| ---------------- | -------- | --------------------------------------------------------------------------- | -------- | -------------- |
| `audio_url`      | string   | URL of the audio file to extend (required if `file_url` not provided).      | Conditional | N/A          |
| `file_url`       | string   | Alternative file URL to extend (required if `audio_url` not provided).      | Conditional | N/A         |
...
```json
{
  ...
  "duration": 30,
  "side": "right",
  "prompt": "Continue with an uplifting bridge section"
}
```
...
{
  "messageId": "...",
  "prompt": "Extend this audio track by 30 seconds while following these instructions: Continue with an uplifting bridge section",
  "albumArt": "https://storage.soundverse.ai/soundverse-album-art/...album_art.png",
  "songName": "Extended Song",
  "status": "COMPLETED",
  "audioData": [
    {
      "audioUrl": "https://storage.soundverse.ai/x-one/.../.../extended_song_v1.mp3",
      "songName": "Extended Song",
      "licenses": {
    ...
    {
      "audioUrl": "https://storage.soundverse.ai/x-one/.../.../extended_song_v2.mp3",
      "songName": "Extended Song",
      "licenses": {
        "licenses": "Royalty Free"
      }
  ...
  "aiReply": "Your song has been extended successfully."
}
```
