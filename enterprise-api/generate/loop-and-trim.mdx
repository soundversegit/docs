...
|----------------|----------|----------|-----------------------------------------------------------------------------|
| `prompt`       | `string` | ✅ Yes    | Textual prompt describing the feel or theme of the music.                  |
| `audioUrl`     | `string` | ✅ Yes    | Public URL of a user uploaded audio file to detect loop from.              |
| `count`        | `int`    | ✅ Yes    | Number of times to loop the detected seamless segment.                     |
...
| `audioUrl`     | `string` | ✅ Yes    | Public URL of a user uploaded audio file to detect loop from.                  |
| `count`        | `int`    | ✅ Yes    | Number of times to loop the detected seamless segment.                     |
| `beatsToInclude`        | `int`    | ✅ Yes    | Number of beats to include in the looped segment.                     |
...
| `audioUrl`     | `string` | ✅ Yes    | Public URL of a user uploaded audio file to detect loop from.                  |
| `count`        | `int`    | ✅ Yes    | Number of times to loop the detected seamless segment.                     |
| `timeRanges`        | `List`    | ✅ Yes    | Time ranges to include in the looped segment.                     |
