...
Users have to hover over the prompt, click on the three dots and select regenrate, the AI will automatically process the request and generate required output.
