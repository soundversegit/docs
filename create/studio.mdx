...
Type in the perfect prompt and then click on the arrow to generate the audio. You can click on the options present at the left of the arrow to select the duration, loop etc.
...
### Selecting duration
 Click on the options present at the left side of the arrow, click on duration and then select 15 seconds or 30 seconds as per your requirement.
...
Click on the options present at the left side of the arrow, click on loop and turn on/off.
