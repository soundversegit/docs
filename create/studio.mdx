...
<IMAGE Interface tour>
This is how Soundverse Studio looks like! You will find eveything out here to create a perfect composition. In the left area of the screen you find the panel which has your projects, explore section and my library. In the middle, we have chat view where in you have extended chat feature, prompt bar and more controls. you will find Arrangement View in the right side of the studio and its controls.
In the top, you will find notification bell icon where in you will find all the new feature or add-on updates and the export tab to download the whole composition of the arrangement view.
