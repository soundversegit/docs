...
const TopLevelColorModeProvider = ({
  ...
  return jsxRuntime.jsxs(core.__ThemeUIInternalBaseThemeProvider, {
    context: newCtx,
    children: [jsxRuntime.jsx(GlobalColorStyles, {
      theme: newTheme
    }), children]
  });
};
...
function GlobalColorStyles({
  ...
  return core.jsx(react$1.Global, {
    styles: () => {
      return {
...
function NestedColorModeProvider({
  ...
  // color mode to apply.
  const [needsRerender, setNeedsRerender] = react.useState(
  ...
  return jsxRuntime.jsx(core.__ThemeUIInternalBaseThemeProvider, {
    context: {
      ...outerCtx,
      theme: newTheme
    },
...
const ColorModeProvider = ({
  ...
  return isTopLevelColorModeProvider ? jsxRuntime.jsx(TopLevelColorModeProvider, {
    outerCtx: outerCtx,
    children: children
  }) : jsxRuntime.jsx(NestedColorModeProvider, {
    outerCtx: outerCtx,
    children: children
  });
};
